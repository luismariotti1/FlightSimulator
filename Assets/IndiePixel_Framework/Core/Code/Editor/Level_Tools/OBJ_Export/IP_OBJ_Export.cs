...
namespace IndiePixel_Framework.Core.Code.Editor.Level_Tools.OBJ_Export
{
    struct ObjMaterial
    {
        public string name;
    ...
    public class IP_OBJ_Export : ScriptableObject 
    {
        #region Variables
...
//        [MenuItem ("GameGlu/Export/Export whole selection to single OBJ")]
        public static void ExportWholeSelectionToSingle()
        {
            ...
            targetFolder = EditorUtility.SaveFilePanel("Export OBJ", Application.dataPath, "EnterName", "obj");
